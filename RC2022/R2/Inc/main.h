...
#define QIFA2_Pin GPIO_PIN_7
#define QIFA2_GPIO_Port GPIOI
#define QIFA3_Pin GPIO_PIN_6
#define QIFA3_GPIO_Port GPIOI
#define QIFA1_Pin GPIO_PIN_2
#define QIFA1_GPIO_Port GPIOI
#define shejian_Pin GPIO_PIN_9
#define shejian_GPIO_Port GPIOI
#define XW_1_Pin GPIO_PIN_0
#define XW_1_GPIO_Port GPIOF
#define DIANYUAN1_Pin GPIO_PIN_2
#define DIANYUAN1_GPIO_Port GPIOH
...
#define QIFA4_Pin GPIO_PIN_2
#define QIFA4_GPIO_Port GPIOA
